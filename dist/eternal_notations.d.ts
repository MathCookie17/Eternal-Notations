...
const break_eternity_js_2 = __importDefault(require("break_eternity.js"));
...
class Notation {
        constructor() {
                ...
                this.NaNString = "???";
                this.isInfinite = (decimal) => (decimal.eq(break_eternity_js_2.default.dInf) || decimal.eq(break_eternity_js_2.default.dNegInf));
                this.name = "";
        }
        //Notation stuff
        format(value) {
                let decimal = (0, utils_js_2.toDecimal)(value);
                if (decimal.isNan())
